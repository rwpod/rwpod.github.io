---
title: '33 випуск 12 сезону. Ruby 3.4.0 preview2, Rails 7.2.1.1, Node v23.0.0, Docx, Fast-grid та інше'
date: 2024-10-21
tags:
  - podcasts
...
- [Ruby 3.4.0 preview2 Released](https://www.ruby-lang.org/en/news/2024/10/07/ruby-3-4-0-preview2-released/)
...
- [Monkey Patch Detection in Ruby](https://tenderlovemaking.com/2024/10/16/monkey-patch-detection-in-ruby/)
...
- [Docx - easily generate and modify .docx files with JS/TS](https://docx.js.org/#/)
- [Fast-grid - the world's most performant DOM-based web table](https://github.com/gabrielpetersson/fast-grid/)
- [ChordSymbol - the definitive chord symbol parser and renderer for Javascript/NodeJS](https://chord-symbol.netlify.app/)
