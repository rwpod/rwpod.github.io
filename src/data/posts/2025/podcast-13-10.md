...
- [37signals' campfire chat app now open source](https://github.com/basecamp/once-campfire)
...
- [Andromeda - a modern, fast, and secure JavaScript & TypeScript runtime built from the ground up in Rust](https://tryandromeda.dev/)
