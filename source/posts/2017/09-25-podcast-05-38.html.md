...
## Ruby
 ...
 - [Add credentials using a generic EncryptedConfiguration class](https://github.com/rails/rails/pull/30067), [Add `with_attached_*` scope to `has_one_attached` macro](https://github.com/rails/rails/pull/30629) и [Don't call us, we'll call you: Sending webhooks with Rails](https://benediktdeicke.com/2017/09/sending-webhooks-with-rails/)
