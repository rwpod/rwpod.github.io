...
## JavaScript
 ...
 - [Ally.js - a JavaScript library simplifying certain accessibility features, functions and behaviors](http://allyjs.io/), [WebGazer.js is an eye tracking library](http://webgazer.cs.brown.edu/), [Bideo.js - a JS library that makes it super easy to add fullscreen background videos](https://rishabhp.github.io/bideo.js/) и [Replicator - an advanced JavaScript objects serialization](https://github.com/inikulin/replicator)
