---
title: "20 выпуск 04 сезона. Rails 5 Features and Changes, Rails has won, MIND Patterns, Stylelint, Pepperoni, Ally.js и прочее"
date: 2016-05-30
tags:
 - podcasts
...
## JavaScript
 ...
 - [React Tutorial: Cloning Yelp](https://www.fullstackreact.com/articles/react-tutorial-cloning-yelp/), [Getting Started with TDD in React](https://semaphoreci.com/community/tutorials/getting-started-with-tdd-in-react), [Pepperoni - React Native App Starter Kit for Android and iOS](http://getpepperoni.com/), [4 Reasons you should try out GraphQL today](https://medium.freecodecamp.com/introduction-to-graphql-1d8011b80159#.o9z7b69fe) и [Building SVG Maps with React](https://blog.komand.com/building-svg-maps-with-react)
 - [Ally.js - a JavaScript library simplifying certain accessibility features, functions and behaviors](http://allyjs.io/), [Microlight.js is a micro-library which improves readability of code snippets by highlighting](http://asvd.github.io/microlight/), [WebGazer.js is an eye tracking library](http://webgazer.cs.brown.edu/), [Bideo.js - a JS library that makes it super easy to add fullscreen background videos](https://rishabhp.github.io/bideo.js/) и [Replicator - an advanced JavaScript objects serialization](https://github.com/inikulin/replicator)
